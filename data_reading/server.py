...
hourly_averages['24'] = dict(temperature=[], humidity=[], pressure=[])
hourly_averages['25'] = dict(temperature=[], humidity=[], pressure=[])
hourly_averages['26'] = dict(temperature=[], humidity=[], pressure=[])
hourly_averages['27'] = dict(temperature=[], humidity=[], pressure=[])
hourly_averages['28'] = dict(temperature=[], humidity=[], pressure=[])
hourly_averages['29'] = dict(temperature=[], humidity=[], pressure=[])
hourly_averages['30'] = dict(temperature=[], humidity=[], pressure=[])
hourly_averages['31'] = dict(temperature=[], humidity=[], pressure=[])
hourly_averages['32'] = dict(temperature=[], humidity=[], pressure=[])
hourly_averages['33'] = dict(temperature=[], humidity=[], pressure=[])
hourly_averages['34'] = dict(temperature=[], humidity=[], pressure=[])
hourly_averages['35'] = dict(temperature=[], humidity=[], pressure=[])
hourly_averages['36'] = dict(temperature=[], humidity=[], pressure=[])
hourly_averages['37'] = dict(temperature=[], humidity=[], pressure=[])
hourly_averages['38'] = dict(temperature=[], humidity=[], pressure=[])
hourly_averages['39'] = dict(temperature=[], humidity=[], pressure=[])
hourly_averages['40'] = dict(temperature=[], humidity=[], pressure=[])
hourly_averages['41'] = dict(temperature=[], humidity=[], pressure=[])
hourly_averages['42'] = dict(temperature=[], humidity=[], pressure=[])
hourly_averages['43'] = dict(temperature=[], humidity=[], pressure=[])
hourly_averages['44'] = dict(temperature=[], humidity=[], pressure=[])
hourly_averages['45'] = dict(temperature=[], humidity=[], pressure=[])
hourly_averages['46'] = dict(temperature=[], humidity=[], pressure=[])
hourly_averages['47'] = dict(temperature=[], humidity=[], pressure=[])
hourly_averages['48'] = dict(temperature=[], humidity=[], pressure=[])
hourly_averages['49'] = dict(temperature=[], humidity=[], pressure=[])
hourly_averages['50'] = dict(temperature=[], humidity=[], pressure=[])
hourly_averages['51'] = dict(temperature=[], humidity=[], pressure=[])
hourly_averages['52'] = dict(temperature=[], humidity=[], pressure=[])
hourly_averages['53'] = dict(temperature=[], humidity=[], pressure=[])
hourly_averages['54'] = dict(temperature=[], humidity=[], pressure=[])
hourly_averages['55'] = dict(temperature=[], humidity=[], pressure=[])
hourly_averages['56'] = dict(temperature=[], humidity=[], pressure=[])
hourly_averages['57'] = dict(temperature=[], humidity=[], pressure=[])
hourly_averages['58'] = dict(temperature=[], humidity=[], pressure=[])
hourly_averages['59'] = dict(temperature=[], humidity=[], pressure=[])
